...
def main():
    ...
    forbidden = [
    "CC50_mM",           # сам таргет
    "CC50_nM",           # преобразованный
    "log_CC50",          # если был
    "log1p_CC50",        # может остаться из старых версий
    "log1p_CC50_nM",     # потенциально создан пользователем
    "SI",                # оригинальный индекс селективности
    "SI_corrected",      # пересчитанный индекс
    "log_SI",            # если логарифмировали
    "log1p_SI",          # log1p селективности
    "SI_diff_check"      # любые технические признаки сравнения
    ]
