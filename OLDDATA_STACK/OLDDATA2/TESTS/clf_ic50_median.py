...
def main():
    ...
    forbidden_cols = [
        'IC50_mM', 'CC50', 'CC50_mM', 'SI', 'SI_corrected', 'log_IC50', 'log_CC50', 'log_SI', 'log1p_IC50_nM',
        'log1p_SI_corrected', 'SI_original', 'SI_diff', 'SI_diff_check', 'SI_check', 'ratio_IC50_CC50'
    ]
        ...
        if hasattr(final_trained_model, 'estimators_') and final_trained_model.estimators_:
            for i, base_pipeline_estimator in enumerate(final_trained_model.estimators_):
                ...
                try:
                    ...
                    logger.warning(f"Не удалось извлечь модель по ключу 'classifier' из пайплайна для {base_est_original_name}.")
